...
| `reader.xml.text.node.value.field.name`     | Specifies the name to be used for naming the field that will contain the value of a TextNode element having attributes. | `string`  | `value`     | Low        |
