...
/**
 * The {@code GcsParquetFileInputReader} can be used for creating records
 * from a parquet file loaded from Google Cloud Storage.
 */
public class GcsParquetFileInputReader extends BaseGcsInputReader {
