package io.streamthoughts.kafka.connect.filepulse.fs.aws.s3;

import com.amazonaws.services.s3.AmazonS3;
import io.findify.s3mock.S3Mock;
import io.streamthoughts.kafka.connect.filepulse.fs.aws.AmazonS3ClientConfig;
import io.streamthoughts.kafka.connect.filepulse.fs.aws.AmazonS3ClientUtils;
...
import static io.streamthoughts.kafka.connect.filepulse.fs.aws.AmazonS3ClientConfig.AWS_ACCESS_KEY_ID_CONFIG;
import static io.streamthoughts.kafka.connect.filepulse.fs.aws.AmazonS3ClientConfig.AWS_S3_BUCKET_NAME_CONFIG;
import static io.streamthoughts.kafka.connect.filepulse.fs.aws.AmazonS3ClientConfig.AWS_S3_REGION_CONFIG;
import static io.streamthoughts.kafka.connect.filepulse.fs.aws.AmazonS3ClientConfig.AWS_SECRET_ACCESS_KEY_CONFIG;
