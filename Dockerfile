...
COPY connect-file-pulse-plugin/target/components/packages/streamthoughts-kafka-connect-file-pulse-plugin-1.3.0-SNAPSHOT.zip /tmp/kafka-connect-file-pulse.zip
