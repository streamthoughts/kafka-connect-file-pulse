...
COPY connect-file-pulse-plugin/target/components/packages/streamthoughts-kafka-connect-file-pulse-plugin-1.1.0-SNAPSHOT.zip /tmp/kafka-connect-file-pulse.zip
