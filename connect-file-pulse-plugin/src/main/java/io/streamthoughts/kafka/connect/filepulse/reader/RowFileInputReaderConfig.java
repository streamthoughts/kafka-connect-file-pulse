 ...
 */
class RowFileInputReaderConfig extends AbstractConfig {
     ...
     */
    RowFileInputReaderConfig(final Map<String, ?> originals) {
    ...
    int skipFooters() { return getInt(READER_FIELD_FOOTER_CONFIG); }
