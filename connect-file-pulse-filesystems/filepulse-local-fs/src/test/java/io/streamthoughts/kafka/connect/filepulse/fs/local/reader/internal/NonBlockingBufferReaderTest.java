...
import static io.streamthoughts.kafka.connect.filepulse.fs.local.reader.internal.ReversedInputFileReader.DEFAULT_INITIAL_CAPACITY;
...
public class NonBlockingBufferReaderTest {
    ...
    private static NonBlockingBufferReader createReaderWithCapacity(final File file,
                                                                    final int defaultInitialCapacity) {
